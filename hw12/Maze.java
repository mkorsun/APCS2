 ...
 *  <If the character hasn't visited all possible paths and isn't at the exit it should, choose a viable path (not a wall or already visited path), and take it If there's no paths, go back.>
 ***/
